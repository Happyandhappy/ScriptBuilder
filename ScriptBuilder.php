...
<head runat="server">
    ...
    <script type="text/javascript">
        function CloseEditor() {
            window.external.notify("'" + document.getElementById('Msg').innerHTML.toString() + "'");
        }
        ...
        function CheckToCloseEditor() {
            var mode = getQuerystring("save", "");
                    ...
                    <div class="panel-inner">
                        <div class="panel" ng-class="{ open: panels.active === 'elements' }" data-name="elements" bl-pretty-scrollbar bl-panels-accordion>
                            ...
                            <div id="elements-list">
                                ...
                                <div class="elements-box accordion-item open" id="dynamic">
                                    <h3 class="accordion-heading">{{ 'dynamic' | translate }} <i class="icon icon-down-open-1"></i></h3>
                                    <div class="accordion-body"><ul class="list-unstyled"></ul></div>
                                </div>
<!--
                                <div class="elements-box accordion-item" id="macroses">
                                    <h3 class="accordion-heading">{{ 'macroses' | translate }} <i class="icon icon-down-open-1"></i></h3>
                                    <div class="accordion-body"><ul class="list-unstyled"></ul></div>
                                </div>
-->
...
<!--
                                <div class="elements-box accordion-item" id="macroses_dev">
                                    <h3 class="accordion-heading">{{ 'macroses_dev' | translate }} <i class="icon icon-down-open-1"></i></h3>
                                    <div class="accordion-body"><ul class="list-unstyled"></ul></div>
                                </div>
-->
                            </div>
...
<!--
                                            <div ng-controller="MediaManagerController" style="visibility:hidden;">
...
-->
                                        <div id="texturePresets">
                                            ...
                                            <ul class="img-presets-list" bl-pretty-scrollbar>
                                                <li ng-repeat="texture in textures track by $index">
                                                    <div ng-click="selectPreset($event)" class="preset" ng-style="{ 'background-image': 'url(ScriptBuilder/images/textures/'+$index+'.png)' }"></div>
                                                </li>
                                            </ul>
                        ...
                        <section>
                            ...
                            <div class="bottom-navigation">
                                <button ng-click="preview()" bl-tooltip="preview" placement="top" style="width:33.3%;"><i class="icon icon-eye"></i></button>
                                <!--<button ng-click="openPanel('export')" bl-tooltip="export" placement="top"><i class="icon icon-export"></i></button>-->
                                <button ng-click="toggleDevicesPanel()" ng-class="{ active: devicesPanelOpen }" bl-tooltip="changeDevice" placement="top" style="width:33.3%;"><i class="icon icon-mobile"></i></button>
                                <button bl-tooltip="save" placement="top" ng-click="project.save()" ng-disabled="savingChanges" style="width:33.3%;">
    ...
    <form runat="server" id="scriptSubmit" name="scriptSubmit" method="post">
        ...
        <script>
            function getScriptContent(html, css, js) {
                ...
                document.getElementById("scriptSubmit").submit(); 
            }
            ...
            function setCssContent() {
                return document.getElementById('cssContent').value;
            }

            function setJsContent() {
                return document.getElementById('jsContent').value;
            }
        </script>
</body>
</html>
